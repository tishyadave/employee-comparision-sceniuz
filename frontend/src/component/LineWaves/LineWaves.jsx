...
export default function LineWaves({
  ...
  const stateRef = useRef({ enableMouseInteraction });

  useEffect(() => {
    stateRef.current.enableMouseInteraction = enableMouseInteraction;
  ...
  useEffect(() => {
    ...
    function handleMouseMove(e) {
      if (!stateRef.current.enableMouseInteraction) return;
    ...
    function update(time) {
      ...
      if (stateRef.current.enableMouseInteraction) {
